        ...
        foreach ($docs as $doc) {
            ...
            if ($imported) {
                ...
                if ($post) {
                    ...
                    switch ($status) {
                        case 'publish': $status_label = 'Publicado'; $status_class = 'g2wpi-status-publish'; break;
                        case 'draft': $status_label = 'Borrador'; $status_class = 'g2wpi-status-draft'; break;
                        case 'pending': $status_label = 'Pendiente'; $status_class = 'g2wpi-status-pending'; break;
                        case 'trash': $status_label = 'Papelera'; $status_class = 'g2wpi-status-trash'; break;
                        default: $status_label = ucfirst($status); $status_class = ''; break;
                    }
            ...
            echo '<tr>';
            echo '<td>' . $nombre . '</td>';
            echo '<td class="g2wpi-status ' . esc_attr($status_class) . '">' . esc_html($status_label) . '</td>';
