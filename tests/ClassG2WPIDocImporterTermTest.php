...
class ClassG2WPIDocImporterTermTest extends TestCase
{
    public static $wp_insert_post_return = 789;
    ...
    public function test_import_with_term_id_sets_terms()
    {
        ...
        if (!function_exists('wp_insert_post')) {
            function wp_insert_post($arr) { return ClassG2WPIDocImporterTermTest::$wp_insert_post_return; }
        }
        ...
        if (!function_exists('wp_set_post_terms')) {
            function wp_set_post_terms($post_id, $terms, $taxonomy) {
                ClassG2WPIDocImporterTermTest::$termsSet = [$post_id, $terms, $taxonomy];
            }
        }
        self::$termsSet = null;
